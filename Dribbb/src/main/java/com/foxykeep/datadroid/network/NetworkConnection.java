...
public final class NetworkConnection {
    ...
    /**
     * Set the POSTDATA text that will be added in the request and also set the {@link com.foxykeep.datadroid.network.NetworkConnection.Method}
     * to use. The Method can only be {@link com.foxykeep.datadroid.network.NetworkConnection.Method#POST} or {@link com.foxykeep.datadroid.network.NetworkConnection.Method#PUT}.
     * <p>
     * The parameters will be reset as they cannot be used at the same time.
     *
     * @param postText The POSTDATA text that will be added in the request.
